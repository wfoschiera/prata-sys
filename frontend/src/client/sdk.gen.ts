...
export class EntradasEstoqueService {
     ...
     * @param data The data for the request.
     * @param data.formData
     * @returns ImportacaoNfePreview Successful Response
     * @throws ApiError
     */
    public static importarNfeXml(data: EntradasEstoqueImportarNfeXmlData): CancelablePromise<EntradasEstoqueImportarNfeXmlResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/entradas-estoque/importar-xml',
            formData: data.formData,
            mediaType: 'multipart/form-data',
            errors: {
                409: 'Chave de acesso já importada',
                422: 'Validation Error'
            }
        });
    }
